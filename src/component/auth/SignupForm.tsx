...
export default function SignupForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload: SignupForm = { username, password, passwordConfirm };
        ...
        <div className='min-h-screen bg-gray-100 flex items-center justify-center'>
            <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-sm'>
                <div className='text-center mb-6'>
                    <h1 className='text-xl font-semibold text-gray-900'>アカウント生成</h1>
                    <p className='text-sm text-gray-500 mt-1'>アカウントを生成してください</p>
                </div>
                <form className='space-y-4' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label className='block text-sm text-gray-600 mb-1' htmlFor=''>パスワード確認</label>
                        <input 
                            type='text' 
